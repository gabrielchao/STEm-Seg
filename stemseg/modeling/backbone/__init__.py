from .backbone import build_resnet_fpn_backbone, build_multi_fusion_backbone
...
BACKBONE_REGISTRY.add("MULTI-FUSION", build_multi_fusion_backbone)

__all__ = [
    BACKBONE_REGISTRY,
    "build_resnet_fpn_backbone",
    "build_multi_fusion_backbone"
]
